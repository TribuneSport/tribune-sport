      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <header className="mb-10 mt-8">
          ...
          <p className="mt-4 text-lg text-gray-600">
            ...
            {articles.length > 1 ? "s" : ""} disponible
            {articles.length > 1 ? "s" : ""}.
          </p>
        </header>

        {articles.length === 0 ? (
          <section className="rounded-3xl bg-white p-16 text-center shadow-lg">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600">
              Aucun article publié n'est actuellement disponible dans la
              catégorie <strong>{category}</strong>.
            </p>

            <Link
              href="/"
              className="mt-8 inline-flex rounded-xl bg-red-700 px-8 py-4 font-bold text-white transition hover:bg-red-800"
            >
              Retour à l'accueil
            </Link>
          </section>
