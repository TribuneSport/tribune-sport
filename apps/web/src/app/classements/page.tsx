...
export default async function ClassementsPage() {
  ...
  for (const standing of standings) {
    const competition =
      competitionMap.get(standing.competitionId);
    ...
    grouped[competitionName].push(standing);
  }
      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <header className="mb-12">
          ...
          <p className="mt-5 max-w-3xl text-lg text-gray-600">
            Retrouvez les classements des différentes compétitions
            suivies par Tribune Foot.
          </p>
        </header>
